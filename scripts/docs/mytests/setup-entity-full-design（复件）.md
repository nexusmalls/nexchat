...
| Level | Name   | 套餐金额 (USDT) | 奖励级数 | 直推要求 | 上层 | 下层 | 提现  | 复投  |
|-------|--------|---------------|---------|---------|------|------|-------|-------|
| 1     | Plan1  | 50             | 6 级    | 无      | 20层 | 30层 | 40%   | 60%   |
| 2     | Plan2  | 100            | 6 级    | 无      | 24层 | 36层 | 40%   | 60%   |
| 3     | Plan3  | 200            | 6 级    | 无      | 28层 | 42层 | 40%   | 60%   |
| 4     | Plan4  | 300            | 6 级    | 无      | 32层 | 48层 | 40%   | 60%   |
| 5     | Plan5  | 500            | 9 级    | 直推 6  | 40层 | 60层 | 50%   | 50%   |
| 6     | Plan6  | 2000           | 12 级   | 直推 9  | 40层 | 60层 | 60%   | 40%   |
| 7     | Plan7  | 5000           | 15 级   | 直推 12 | 40层 | 60层 | 70%   | 30%   |
...
Pool-Reward 插件（沉淀资金分红） 5、6、7平分
87.5元
团队：           或者团队增加 个 直推增加1个 、间推增加 1个 2% 1% 0.5% 
5 1 1%； 1 1%  
6 2 1%； 1 0.5% 
7 4 1%； 1 0.25%
...
#### 5a. Multi-Level 插件（动态奖励 — 太阳线 15 级）
...
| L9   | 第九级  | 2%      | 200        | 6                | 0                  | 0              |
| L10  | 第十级  | 5%      | 200        | 9                | 0                  | 0              |
| L11  | 第十一级 | 2%     | 200        | 9                | 0                  | 0              |
| L12  | 第十二级 | 2%     | 200        | 9                | 0                  | 0              |
| L13  | 第十三级 | 2%     | 500        | 12                | 0                  | 0              |
| L14  | 第十四级 | 2%     | 200        | 12                | 0                  | 0              |
| L15  | 第十五级 | 2%     | 500        | 12                | 0                  | 0              |

```
maxTotalRate = 4702 (cap=4702, 各级 rate 总和=6700 超出部分被 maxTotalRate 截断)
```

**解锁逻辑：** 套餐1~4 只能拿 7 级，套餐5 拿 9 级，套餐6 拿 11 级，套餐7 拿 13 级。
这通过会员等级 + 链上引擎的 `member level → unlocked tiers` 映射来实现（engine 层面根据会员等级截断层数）。

#### 5b. Single-Line 插件（静态奖励 — 全网一条线公排, cap=4000）
