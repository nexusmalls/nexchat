...
use sc_consensus_babe::{self, BabeLink, BabeWorkerHandle, ImportQueueParams, SlotProportion};
...
pub fn new_partial(
    ...
    sc_service::PartialComponents<
        ...
        (
            impl sc_consensus::BlockImport<Block, Error = sp_consensus::Error> + Send + Sync,
            BabeLink<Block>,
...
> {
    ...
    // BABE configuration from runtime
    let babe_config = sc_consensus_babe::configuration(&*client)?;
    let slot_duration = babe_config.slot_duration();

    // BABE block import wraps Grandpa block import
