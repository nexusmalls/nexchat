...
fn edit_market_with_foreign_asset() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        // ALICE is market creator through simple_create_categorical_market.
        // The collateral policy does not whitelist this foreign asset.
        assert_noop!(
            PredictionMarkets::edit_market(
                RuntimeOrigin::signed(ALICE),
        ...
        // A second non-whitelisted asset is rejected identically.
        assert_noop!(
            PredictionMarkets::edit_market(
                RuntimeOrigin::signed(ALICE),
        ...
        // The live collateral fixture explicitly whitelists USDX.
        assert_ok!(PredictionMarkets::edit_market(
            RuntimeOrigin::signed(ALICE),
        ...
        assert_eq!(market.base_asset, Asset::ForeignAsset(USDX_ASSET_ID));
    });
}
