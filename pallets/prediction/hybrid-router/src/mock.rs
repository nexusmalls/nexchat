...
use frame_support::{
    ...
    traits::{
        ...
        AsEnsureOriginWithArg, ConstU32, Contains, Everything, ExistenceRequirement,
        NeverEnsureOrigin, Randomness,
    },
    Blake2_256, PalletId,
};
...
parameter_types! {
    pub const CollateralPalletId: PalletId = PalletId(*b"hr/collt");
}
