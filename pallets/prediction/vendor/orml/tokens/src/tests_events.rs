...
fn pallet_fungibles_mutate_hold_deposit_events() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            assert_ok!(
                <Tokens as fungibles::MutateHold<AccountId>>::transfer_on_hold(
                    DOT,
                    REASON,
                    &ALICE,
                    &BOB,
...
fn pallet_change_locks_events() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        assert!(
            events().contains(&RuntimeEvent::Tokens(crate::Event::Locked {
                currency_id: DOT,
                who: ALICE,
                amount: 10
            }))
        ...
        assert!(
            events().contains(&RuntimeEvent::Tokens(crate::Event::Unlocked {
                currency_id: DOT,
                who: ALICE,
                amount: 4
            }))
...
fn pallet_multi_lockable_currency_extend_lock_events() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            assert!(
                events().contains(&RuntimeEvent::Tokens(crate::Event::LockSet {
                    lock_id: ID_1,
                    currency_id: DOT,
                    who: ALICE,
                    amount: 20,
