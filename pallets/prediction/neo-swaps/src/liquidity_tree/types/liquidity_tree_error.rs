...
#[derive(
    Decode, DecodeWithMemTracking, Encode, Eq, PartialEq, PalletError, RuntimeDebugNoBound, TypeInfo,
)]
/// Liquidity-tree account, stake, fee, and capacity failures.
/// 流动性树的账户、份额、费用与容量错误。
...
/// Bounded liquidity-tree storage overflow locations.
/// 有界流动性树发生存储溢出的具体位置。
