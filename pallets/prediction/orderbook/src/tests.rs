...
fn it_fills_order_fully_maker_outcome_asset() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        assert_eq!(
            market_creator_balance_after - market_creator_balance_before,
            taker_fees
        );
        ...
        assert_eq!(
            bob_taker_asset_free,
            INITIAL_BALANCE + taker_amount - taker_fees
        );
...
fn it_fills_order_fully_maker_base_asset() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        assert_eq!(
            ...
            INITIAL_BALANCE + maker_amount_minus_fees
        );
...
fn it_fills_order_partially_maker_base_asset() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        assert_eq!(
            market_creator_free_after - market_creator_free_before,
            maker_fees
        );
        ...
        assert_eq!(
            alice_maker_asset_free,
            INITIAL_BALANCE + filled_maker_amount_minus_fees
        );
...
fn it_removes_order() {
    ExtBuilder::default().build().execute_with(|| {
        ...
        assert_ok!(Orderbook::remove_order(
            RuntimeOrigin::signed(ALICE),
            order_id
        ));
