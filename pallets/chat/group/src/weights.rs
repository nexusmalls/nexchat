...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    fn publish_key_package() -> Weight {
        Weight::from_parts(78_922_000, 3521)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    fn revoke_key_package() -> Weight {
        Weight::from_parts(77_512_000, 7627)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    fn create_group() -> Weight {
        Weight::from_parts(97_774_000, 7515)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(6))
    }
    fn claim_welcome() -> Weight {
        Weight::from_parts(47_332_000, 11731)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    fn anchor_message_digest() -> Weight {
        Weight::from_parts(66_456_000, 3698)
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    fn request_join() -> Weight {
        Weight::from_parts(75_509_000, 3698)
            .saturating_add(T::DbWeight::get().reads(6))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    fn cancel_join_request() -> Weight {
        Weight::from_parts(56_766_000, 3541)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    fn approve_join() -> Weight {
        Weight::from_parts(71_539_000, 6110)
            .saturating_add(T::DbWeight::get().reads(5))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    fn transfer_ownership() -> Weight {
        Weight::from_parts(73_975_000, 6110)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    fn set_admin() -> Weight {
        Weight::from_parts(57_259_000, 3698)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    fn set_group_profile() -> Weight {
        Weight::from_parts(52_981_000, 5767)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    fn set_group_nickname() -> Weight {
        Weight::from_parts(46_230_000, 3550)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    fn ban_member() -> Weight {
        Weight::from_parts(71_352_000, 3698)
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    fn unban_member() -> Weight {
        Weight::from_parts(61_456_000, 3698)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    fn set_member_mute() -> Weight {
        Weight::from_parts(67_273_000, 6110)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    fn set_group_mute_all() -> Weight {
        Weight::from_parts(50_779_000, 3698)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    fn set_group_frozen() -> Weight {
        Weight::from_parts(38_962_000, 3698)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
    ...
    fn commit(a: u32, r: u32) -> Weight {
        Weight::from_parts(85_977_301, 3698)
            .saturating_add(Weight::from_parts(68_748_883, 16269).saturating_mul(a.into()))
            .saturating_add(Weight::from_parts(69_317_951, 16269).saturating_mul(r.into()))
            .saturating_add(T::DbWeight::get().reads(4))
    ...
    fn disband_group() -> Weight {
        ...
        Weight::from_parts(214_771_000, 7515)
